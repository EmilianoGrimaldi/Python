...
def buscar_maximo(lista,campo):
    flag_mas_alto = True
    for personaje in lista:
        if flag_mas_alto or personaje[campo] >= altura_maxima:
            altura_maxima = personaje[campo]
            flag_mas_alto = False
...
def buscar_minimo(lista,campo):
    flag_mas_bajo = True
    for personaje in lista:
        if flag_mas_bajo or personaje[campo] <= altura_minima:
            altura_minima = personaje[campo]
            flag_mas_bajo = False
